...
1. Clone repository ini ke komputer lokal Anda dengan menjalankan perintah berikut:
   ...
   ```shell
   git clone https://github.com/kaawaaii/Analisis-data-dengan-Python.git
...
Atau, Anda dapat mengunjungi Project Data Analytics untuk melihat dashboard hasil analisis data. [https://proyekanbikesharing.streamlit.app/]
